...
//        }
//
//        public Test(String id, String parentId, boolean leaf) {
//            this.id = id;
//            this.parentId = parentId;
//            this.leaf = leaf;
//        }
...
//        Test test = new Test("1", null, false);
//        Test test1 = new Test("2", "1", false);
//        Test test2 = new Test("3", null, false);
//        Test test3 = new Test("4", "3", true);
//        Test test4 = new Test("5", "3", false);
//        Test test5 = new Test("6", "2", true);
//        Test test6 = new Test("7", "1", true);
//        Test test7 = new Test("8", "5", true);
...
//        tests.add(test6);
//        tests.add(test7);
//        List<Test> tests1 = listToTree(tests, "children", "parentId", "id", t -> t.getParentId() == null, Test::isLeaf);
////        List<Test> tests2 = listToTree(tests, "children", "parentId", "id", t -> t.getParentId() == null, null);

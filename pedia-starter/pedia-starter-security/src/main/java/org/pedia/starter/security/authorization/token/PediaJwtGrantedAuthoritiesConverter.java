...
/**
 * copy from JwtGrantedAuthoritiesConverter
 */
public class PediaJwtGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    public Collection<GrantedAuthority> convert(Jwt jwt) {
        ...
        // include scope and authorities
        List<SimpleGrantedAuthority> authorityList = jwt.getClaimAsStringList(SecurityConstant.CLAIM_AUTHORITY)
                .stream()
     ...
     * {@link PediaJwtGrantedAuthoritiesConverter#DEFAULT_AUTHORITY_PREFIX}.
     ...
     * {@link PediaJwtGrantedAuthoritiesConverter#WELL_KNOWN_AUTHORITIES_CLAIM_NAMES}.

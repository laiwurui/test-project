package org.pedia.starter.security.authorization.password;
...
public class OAuth2UsernamePasswordAuthenticationProvider implements AuthenticationProvider {
     ...
     * @since 0.2.3
     */
    public OAuth2UsernamePasswordAuthenticationProvider(AuthenticationManager authenticationManager,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        OAuth2UsernamePasswordAuthenticationToken resouceOwnerPasswordAuthentication = (OAuth2UsernamePasswordAuthenticationToken) authentication;
    ...
    public boolean supports(Class<?> authentication) {
        boolean supports = OAuth2UsernamePasswordAuthenticationToken.class.isAssignableFrom(authentication);
        LOGGER.debug("supports authentication=" + authentication + " returning " + supports);
        return supports;
    }

    private Authentication getUsernamePasswordAuthentication(OAuth2UsernamePasswordAuthenticationToken resouceOwnerPasswordAuthentication) {
